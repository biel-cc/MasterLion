  ...
  links: [
    {
      ...
      url: 'https://github.com/chaaak6/Masterino/pull/15766',
    },
  ],
...
export default defineFixtures({
  ...
  fixtures: {
    ...
    TaskOutput: single({
      ...
      content:
        '✅  Vite: compile and bundle finished (200) http://localhost:9876/\nDebug Proxy: https://aihub.bielcrystal.com/_dangerous_local_dev_proxy?debug-host=http://localhost:9876',
    }),
    TaskStop: single({
    ...
    WebFetch: single({
      args: {
        ...
        url: 'https://github.com/chaaak6/Masterino/releases/latest',
      },
      content:
