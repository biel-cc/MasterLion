...
import SubmitMcpModal from '../../user/features/SubmitMcpModal';
...
const WorkspacePluginList = memo<WorkspacePluginListProps>(({ rows = 4, pageSize = 8 }) => {
  ...
  const { plugins = [], canEdit, onRefreshProfile } = useWorkspaceDetailContext();
  ...
  if (plugins.length === 0 && !canEdit) return null;
