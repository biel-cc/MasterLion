---
title: Automatic Synchronization with Masterino Desktop
description: Configure Masterino Desktop for a synchronized experience
tags:
  - Masterino
...
# Automatic Synchronization with Masterino Desktop

Masterino Desktop provides users with an enhanced experience while also expanding the capabilities of Masterino, allowing users to utilize Masterino in offline environments. This document will guide you on how to configure Masterino Desktop and connect it to your self-hosted instance.

## System Requirements

Masterino Desktop is built using Electron and supports the following operating systems:
...
The version release of Masterino Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of Masterino Desktop.
...
Masterino Desktop can connect to your self-hosted Masterino instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying Masterino using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
1. Open Masterino Desktop.
2. Click the Wi-Fi icon in the upper right corner.
3. Enter the address of your self-hosted instance (e.g., `https://your-Masterino-instance.com`).
...
- Example file names:
  - Apple Silicon: `Masterino-Beta-1.83.6-arm64.dmg` or `Masterino-Beta-1.83.6-arm64-mac.zip`
  - Intel: `Masterino-Beta-1.83.6-x64.dmg` or `Masterino-Beta-1.83.6-mac.zip`
