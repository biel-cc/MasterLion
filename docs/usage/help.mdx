...
title: Help & Support
description: >-
  Get help with Masterino — common guides, community support, issue reporting, and
  how to reach us.
tags:
  - Masterino
  - Help
...
- [Get Masterino](/docs/usage/getting-started/get-lobehub) — Browser, desktop, or mobile
- [Create Your First Agent](/docs/usage/getting-started/agent)
- [Try Masterino](/docs/usage/getting-started/lobe-ai)
...
| **Reddit**        | Discussions and community updates         | [r/Masterino](https://www.reddit.com/r/Masterino/)                        |
