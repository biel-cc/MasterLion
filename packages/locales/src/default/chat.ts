export default {
  ...
  'claudeCodeInstallGuide.reason': 'Masterino could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Masterino could not start Codex: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through Masterino's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'Masterino optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to Masterino',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not Masterino's, and Masterino takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'Masterino will run this task when no assignee is set',
  ...
  'upload.parseFailed': 'File analysis failed',
  'upload.parseFailedDesc':
    '{{filename}} was uploaded, but Masterino could not extract its text. This is not an object storage upload failure. Remove the file and upload it again before sending.',
  'upload.preview.prepareTasks': 'Preparing chunks...',
  'upload.preview.status.chunkFailed': 'Chunking failed',
  'upload.preview.status.chunking': 'Chunking...',
  'upload.preview.status.contentParsing': 'Analyzing file...',
  'upload.preview.status.embedding': 'Vectorizing...',
  'upload.preview.status.embeddingFailed': 'Vectorization failed',
  'upload.preview.status.error': 'Analysis failed',
  'upload.preview.status.failed': 'Failed',
  'upload.preview.status.recordFailed': 'File record failed',
  'upload.preview.status.pending': 'Preparing to upload...',
  'upload.preview.status.processing': 'Processing file...',
  'upload.preview.status.saving': 'Saving file...',
  'upload.preview.status.uploadFailed': 'Upload failed',
  ...
  'workspaceRuntime.chip.alreadyBoundHint':
    'This topic already has a workspace. Create a new referenced topic to use another directory.',
  'workspaceRuntime.chip.boundTooltip': 'Workspace locked for this topic: {{path}}',
  ...
  'workspaceRuntime.hetero.gate.action': 'Choose workspace',
  'workspaceRuntime.hetero.gate.desc':
    'Choose a formal workspace before this agent can start or resume.',
  'workspaceRuntime.hetero.gate.scratchDesc':
    'Temporary directories cannot run this agent. Create a referenced topic in a formal workspace.',
  'workspaceRuntime.hetero.gate.scratchTitle': 'Formal workspace required',
  'workspaceRuntime.hetero.gate.title': 'Workspace required',
  'workspaceRuntime.hetero.gate.unrouted.ambiguous-online-devices':
    'Several devices are online. Choose one before selecting a workspace.',
  ...
  'workspaceRuntime.hetero.gate.unrouted.no-bound-device':
    'Choose a target device before selecting a workspace.',
  ...
  'workspaceRuntime.picker.bindFailed': "Couldn't select this workspace. Try again.",
  'workspaceRuntime.picker.chooseFolder': 'Choose folder',
  'workspaceRuntime.picker.empty': 'No workspace or recent directory yet.',
  'workspaceRuntime.picker.loadError': "Couldn't load workspace information.",
  'workspaceRuntime.picker.loading': 'Loading workspace information…',
  ...
  'workspaceRuntime.picker.title': 'Choose a workspace',
  'workspaceRuntime.picker.unboundTooltip':
    'This topic is not bound. Recommended directories are suggestions only.',
  ...
  'workspaceRuntime.picker.workspaces': 'Workspaces',
  ...
  'workspaceRuntime.sidebar.cleanupScratchConfirm':
    'Delete this topic and its temporary workspace directory? This cannot be undone.',
  'workspaceRuntime.sidebar.loadError': "Couldn't load workspaces",
