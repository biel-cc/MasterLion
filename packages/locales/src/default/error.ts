export default {
  'contextBudget.action.detachAttachments': 'Remove attachments',
  'contextBudget.action.forkTopic': 'New branch topic',
  'contextBudget.action.retryCompression': 'Retry summary',
  'contextBudget.action.retryCompressionUnavailable':
    'Compressing again will not help: there is no earlier history left to summarize.',
  ...
  'contextBudget.desc.RETRY_EXHAUSTED':
    'The context was compressed once and the model still rejected the request. Automatic retries will not continue.',
  'contextBudget.desc.SUMMARY_FAILED':
    'The summary could not be generated. Your original messages were not replaced and are still in place.',
  'contextBudget.desc.TAIL_TOO_LARGE':
    "Your newest message or attachment alone exceeds the model's context window, so compressing earlier history cannot help.",
  'contextBudget.diagnostics.attempt': 'Compression attempt',
  'contextBudget.diagnostics.attemptValue': '{{attempt}} of {{limit}}',
  'contextBudget.diagnostics.dominantSources': 'Dominant sources',
  'contextBudget.diagnostics.estimatedPrompt': 'Estimated prompt',
  'contextBudget.diagnostics.model': 'Model',
  'contextBudget.diagnostics.sourceShare': '{{source}} ~{{tokens}} tokens ({{share}})',
  'contextBudget.diagnostics.toggle': 'Diagnostics',
  'contextBudget.diagnostics.tokens': '~{{tokens}} tokens',
  'contextBudget.diagnostics.window': 'Effective window',
  'contextBudget.diagnostics.windowSource.assumed': 'assumed default',
  'contextBudget.diagnostics.windowSource.manual': 'manual setting',
  'contextBudget.diagnostics.windowSource.observed': 'reported by provider',
  'contextBudget.diagnostics.windowUnknown':
    'The real window is unknown; a conservative default was used.',
  'contextBudget.diagnostics.windowValue': '{{tokens}} tokens ({{source}})',
  'contextBudget.hint.detachAttachments': 'Remove or replace large attachments',
  'contextBudget.hint.forkTopic': 'Start a new branch topic to leave the oversized context behind',
  'contextBudget.hint.shortenMessage': 'Shorten your latest message',
  'contextBudget.hint.switchCompressionModel': 'Use a different model for compression',
  'contextBudget.hint.switchModel': 'Switch to a model with a larger context window',
  'contextBudget.hint.truncateToolResults': 'Truncate long tool results',
  'contextBudget.hintsLabel': 'What you can do',
  'contextBudget.largestSource': 'Largest source: {{source}} (~{{tokens}} tokens)',
  'contextBudget.note.autoRetryStopped':
    'To avoid loops and double billing, the request will not be retried automatically.',
  'contextBudget.note.originalsPreserved':
    'Nothing was replaced. You can retry the summary or continue with a different model.',
  'contextBudget.source.attachment': 'Attachment',
  'contextBudget.source.system': 'System prompt',
  'contextBudget.source.text': 'Message text',
  'contextBudget.source.toolResult': 'Tool result',
  'contextBudget.source.tools': 'Tool definitions',
  'contextBudget.title.NO_CANDIDATES': 'Nothing left to compress',
