export default {
  ...
  'builtins.lobe-agent.title': 'Masterino Agent',
  ...
  'protocolInstall.official.badge': 'Masterino Official Skill',
  'protocolInstall.official.description':
    'Official Masterino Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Masterino does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to Masterino',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Masterino Skills',
