export default {
  ...
  'screen4.share.title': 'Help Improve Masterino',
  ...
  'screen5.actions.signInCloud': 'Sign in to Masterino Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Masterino Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Masterino Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Masterino server instance',
