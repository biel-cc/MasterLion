export default {
  ...
  'FileParsingStatus.chunks.embeddingStatus.errorResult':
    'Vectorization failed after the file was uploaded and chunked. This is not an object storage upload failure. Error detail:',
  ...
  'HtmlPreview.actions.copyFailed': 'Failed to copy HTML',
  ...
  'ModelSelect.inputModality.audio': 'Audio input',
  'ModelSelect.inputModality.file': 'File input',
  'ModelSelect.inputModality.image': 'Image input',
  'ModelSelect.inputModality.notVerified': 'Not verified yet',
  'ModelSelect.inputModality.separator': ', ',
  'ModelSelect.inputModality.source': 'Source: {{source}}',
  'ModelSelect.inputModality.sourceKind.catalog': 'Model catalog',
  'ModelSelect.inputModality.sourceKind.default': 'Default assumption',
  'ModelSelect.inputModality.sourceKind.keyword': 'Model id keyword',
  'ModelSelect.inputModality.sourceKind.manual': 'Manual override',
  'ModelSelect.inputModality.sourceKind.observed': 'Observed request',
  'ModelSelect.inputModality.sourceKind.providerMeta': 'Provider metadata',
  'ModelSelect.inputModality.sourceKind.unknown': 'No evidence',
  'ModelSelect.inputModality.state.supported': 'Supported',
  'ModelSelect.inputModality.state.unknown': 'Unverified',
  'ModelSelect.inputModality.state.unsupported': 'Unsupported',
  'ModelSelect.inputModality.supported.audio': 'Supports audio input',
  'ModelSelect.inputModality.supported.file': 'Supports file input',
  'ModelSelect.inputModality.supported.image': 'Supports image input',
  'ModelSelect.inputModality.supported.video': 'Supports video input',
  'ModelSelect.inputModality.textOnly': 'Text only',
  'ModelSelect.inputModality.textOnlyDesc':
    'Only text input is supported. Image, audio, video and file input are unsupported.',
  'ModelSelect.inputModality.unverified': 'Unverified',
  'ModelSelect.inputModality.unverifiedDesc':
    'Input modality evidence is incomplete. Not yet verified: {{modalities}}.',
  'ModelSelect.inputModality.verifiedAt': 'Verified {{date}}',
  'ModelSelect.inputModality.video': 'Video input',
  'ModelSelect.removed':
