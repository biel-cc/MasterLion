export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>ai@bielcrystal.com</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>ai@bielcrystal.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in Masterino',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Masterino Community.',
  'footer.title': 'Share your creation on Masterino Community today',
  ...
  'models.providerInfo.apiTooltip': 'Masterino supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Masterino Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Masterino',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Masterino automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Masterino marketplace with one click.',
