export default {
  ...
  'agentPicker.installFailed': 'Some assistants could not be installed. Review the errors below and try again.',
  'agentPicker.installUnknownError': 'Installation did not complete. Please try again.',
  ...
  'interests.saveError': 'Your interests could not be saved. Please try again.',
  ...
  'telemetry.title3': "Ready? Let's get started!",
