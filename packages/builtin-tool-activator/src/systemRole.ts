...
- User mentions: "SKILL.md", "Masterino Skills", "skill store", "install skill", "search skill"
- User provides a GitHub link to install a skill (e.g., github.com/xxx/xxx containing SKILL.md)
- User mentions installing from the Masterino marketplace
- User provides Masterino skill URLs like: \`https://aihub.bielcrystal.com/skills/{identifier}/skill.md\` → extract identifier and use \`importFromMarket\`
...
2. **For Masterino skill URLs** (e.g., \`https://aihub.bielcrystal.com/skills/{identifier}/skill.md\`):
...
- For \`aihub.bielcrystal.com/skills/xxx/skill.md\` URLs, ALWAYS extract the identifier and use \`importFromMarket\`, NOT \`importSkill\`
...
- **SKILL-FIRST: Any mention of skills, SKILL.md, GitHub skill links, or Masterino marketplace → activate \`lobe-skill-store\` FIRST, no exceptions.**
