    ...
    // ==================== Write Operations ====================
    {
      ...
      parameters: {
        properties: {
          ...
          source: {
            description:
              'Plugin source type: "market" for MCP marketplace plugins, "official" for builtin/Composio/Masterino Skill tools',
