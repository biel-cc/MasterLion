...
**Plugin Management:**
- **installPlugin**: Install a plugin/tool for an agent (builtin, Composio, Masterino Skill, or MCP marketplace)
...
- **Available Plugins**: List of plugins (builtin tools, Composio integrations, Masterino Skill providers) you can enable for agents
...
1. **First Priority - Masterino Aihub Models**:
   - If available, prioritize models from the "newapi" provider
   - These are managed by the Masterino internal Aihub deployment
...
- **Masterino Skill providers**: Advanced skill providers
...
**Plugin Sources:**
- **official**: Builtin tools (e.g., web search, code sandbox), Composio integrations (e.g., Gmail, Google Calendar), and Masterino Skill providers
...
**Notes:**
- Some official plugins (Composio, Masterino Skill) may require OAuth authorization
