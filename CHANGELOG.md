...
- **misc**: add security monitoring guardrails.
...
- **misc**: add security monitoring guardrails ([57919b6](https://github.com/chaaak6/Masterino/commit/57919b6))
...
- **misc**: enforce runtime response header hardening.
...
- **misc**: enforce runtime response header hardening, closes [#44](https://github.com/chaaak6/Masterino/issues/44) ([e7ea9ae](https://github.com/chaaak6/Masterino/commit/e7ea9ae))
...
### [Version 1.0.6](https://github.com/chaaak6/Masterino/compare/v1.0.5...v1.0.6)

<sup>Released on **2026-07-24**</sup>

#### 🐛 Bug Fixes

- **misc**: support hardened ACK ingress policy.
...
- **misc**: support hardened ACK ingress policy, closes [#43](https://github.com/chaaak6/Masterino/issues/43) ([e37ba4f](https://github.com/chaaak6/Masterino/commit/e37ba4f))
...
- **ci**: repair all failing Actions workflows.
...
- **ci**: repair all failing Actions workflows, closes [#38](https://github.com/chaaak6/Masterino/issues/38) ([0331c2e](https://github.com/chaaak6/Masterino/commit/0331c2e))
