    ...
    return {
      ...
      installPlugin: async (
        ...
        if (source === 'official') {
          ...
          return {
            content: `Installing official integrations that require OAuth (Composio, Masterino Skill) is not supported in background execution. Please install "${identifier}" from the Agent Builder UI instead.`,
